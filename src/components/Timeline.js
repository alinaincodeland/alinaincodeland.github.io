    ...
    <VerticalTimeline>
      ...
      >
        ...
        <p>
          ...
          successfully deploying frontend features and collaborating with design
          and frontend teams using Git/Gitlab, Jira, and Figma.
        </p>
      </VerticalTimelineElement>
      <VerticalTimelineElement
        className="vertical-timeline-element"
      ...
      >
        <h4 className="vertical-timeline-element-title">Frontend Developer</h4>
        <p>
          Substituted Vuetify 2 framework on an internal business platform with
